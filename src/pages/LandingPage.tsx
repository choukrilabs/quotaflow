    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-[#1E3A5F] py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            to="/auth"
            className="inline-block bg-[#2563EB] text-white font-semibold px-8 py-4 rounded-lg hover:bg-blue-700 transition-colors text-lg"
          >
            Start Free Trial
          </Link>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center">
                <svg className="w-5 h-5 text-[#10B981] mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <Link
              to="/auth"
              className="block w-full bg-[#2563EB] text-white font-semibold text-center py-3 rounded-lg hover:bg-blue-700 transition-colors"
            >
              Start Free Trial
            </Link>
          </div>
